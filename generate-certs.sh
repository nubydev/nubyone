#!/bin/bash
# Generate self-signed TLS certificates for Nubyone
...
echo "  1. Set environment variable: NUBYONE_TLS=true"
echo "  2. Optionally set custom paths:"
echo "     NUBYONE_TLS_CERT=$CERT_DIR/server.crt"
echo "     NUBYONE_TLS_KEY=$CERT_DIR/server.key"
echo ""
