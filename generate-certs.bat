@echo off
REM Generate self-signed TLS certificates for Nubyone (Windows)
...
echo =========================================
echo Generating TLS Certificates for Nubyone
echo =========================================
...
echo   1. Set environment variable: set NUBYONE_TLS=true
echo   2. Optionally set custom paths:
echo      set NUBYONE_TLS_CERT=%CERT_DIR%\server.crt
echo      set NUBYONE_TLS_KEY=%CERT_DIR%\server.key
echo.
